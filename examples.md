...
The prototype can either be a plain object or an object type (as in the example below). An object type may in fact be a plain object in addition to a type definition, or it may simply be a [protocol or interface](https://en.wikipedia.org/wiki/Protocol_(object-oriented_programming)), depending on its fields.
