...
The prototype can either be a plain object or an object type (as in the example below). An object type may stil be used a plain object in addition to a type definition, or it may simply be used as a [protocol/interface](https://en.wikipedia.org/wiki/Protocol_(object-oriented_programming)).
